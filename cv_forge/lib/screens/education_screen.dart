...
class EducationScreen extends StatelessWidget {
  ...
  EducationScreen({required this.cvName});
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Expanded(
            child: Center(
              child: Text('Education Screen for CV: $cvName'),
            ),
          ),
          Align(
              ...
              child: FloatingActionButton.extended(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SkillsScreen(cvName: cvName),
                    ),
                  );
                },
                label: Text("Next"),
              ...
              onPressed: () {
                if (newCvName.isNotEmpty) {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => EducationScreen(cvName: newCvName),
                    ),
                  );
                }
              },
